package dev.rodni.ru.retrofittutorialsnotapp.Lesson6;
...
public class Activity6 extends AppCompatActivity {
    ...
    final String URL = "https://yastatic.net/s3/home/logos/citylogos/tetris2019/ru.png";
    ...
    private void downloadFile(String url) {
        ...
        Call<ResponseBody> call = client.downloadFileStream(url);
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                Toast.makeText(Activity6.this, "wrong", Toast.LENGTH_SHORT).show();
            }
        });
    }
